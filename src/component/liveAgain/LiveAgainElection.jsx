...
function LiveAgainElection() {
    ...
    //     const apiUrl = `http://localhost:8091/api/constituency/${constituencyNumber}/election-status/true`;
    ...
    const startLiveElection = async () => {
        ...
        const resetVotesApi = `http://localhost:8091/api/party/resetVotes?constituencyId=${constituencyNumber}`;
        const electionStatusApi = `http://localhost:8091/api/constituency/${constituencyNumber}/election-status/true`;
