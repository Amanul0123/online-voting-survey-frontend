        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <p>👨‍💻 <strong>Developed by: Amanul Haque</strong></p>
            ...
            <div className={styles.copyright}>
                ...
                <p>
                    📧 Contact: 
                    <a href="mailto:amanulhaque376@gmail.com">
                        <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> amanulhaque376@gmail.com
                    </a>
                </p>
            </div>
        </footer>
