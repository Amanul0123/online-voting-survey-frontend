...
function ActiveElection() {
    ...
    const fetchActiveElections = async () => {
        try {
            const response = await axios.get("http://localhost:8091/api/constituency/active");
    ...
    //     try {
    //         await axios.put(`http://localhost:8091/api/constituency/${id}/election-status/false`);
    ...
    const handleDeactivate = async (id) => {
        try {
            ...
            await axios.put(`http://localhost:8091/api/user/reset-votes/${id}`);
